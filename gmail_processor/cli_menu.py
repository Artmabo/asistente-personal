...
def _menu_smart_setup(get_svc: Callable):
    ...
    print(f"    • Recorre TODOS los correos de bandeja de entrada y enviados")
    print(f"      de los últimos 12 meses (sin límite de cantidad)")
    print(f"    • Tiempo estimado: varía según el volumen de tu cuenta")
    print(f"      (varios minutos en cuentas activas)")
    print()
