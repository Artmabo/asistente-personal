...
def get_gmail_service(creds_path="config/credentials.json", token_path="token.json"):
    ...
    if not creds or not creds.valid:
        ...
        # Guardar token (tanto si fue refrescado como si es nuevo), con permisos
        # restringidos (solo lectura/escritura para el dueño) para no exponer
        # el refresh token a otros usuarios del sistema.
